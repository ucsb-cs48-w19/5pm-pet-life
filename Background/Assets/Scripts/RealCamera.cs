/*Code based from "https:/ /forum.unity.com/threads/complete-camera-collision-detection-third-person-games.347233/"*/
...
public class RealCamera : MonoBehaviour{
    ...
    public float minDistance = 10;                //min camera distance
    public float maxDistance = 12;                //max camera distance
